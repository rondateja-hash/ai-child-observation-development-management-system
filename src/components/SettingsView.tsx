...
import { Save, ShieldAlert, Key, Globe, Mail, Landmark, Loader2, Sparkles, CheckCircle, Info } from "lucide-react";
...
export default function SettingsView({ user, addToast }: SettingsProps) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs font-semibold">
            <div>
              ...
              <input
                ...
                onChange={(e) => setSettings(prev => prev ? { ...prev, schoolName: e.target.value } : null)}
                className="block w-full px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-lg text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500/15 focus:border-blue-500 text-sm font-semibold"
              />
            </div>
            ...
            <div>
              ...
              <input
                type="text"
                disabled={user.role !== "Super Admin"}
                value={settings?.centreBranch || ""}
                onChange={(e) => setSettings(prev => prev ? { ...prev, centreBranch: e.target.value } : null)}
                className="block w-full px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-lg text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500/15 focus:border-blue-500 text-sm font-semibold"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setSettings(prev => prev ? { ...prev, portalUrl: e.target.value } : null)}
                className="block w-full px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-lg text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500/15 focus:border-blue-500 text-sm font-semibold"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs font-semibold">
            <div>
              ...
              <input
                ...
                onChange={(e) => setSettings(prev => prev ? { ...prev, smtpHost: e.target.value } : null)}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setSettings(prev => prev ? { ...prev, smtpPort: Number(e.target.value) } : null)}
                className="block w-full px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-lg text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500/15 focus:border-blue-500 text-sm"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setSettings(prev => prev ? { ...prev, smtpUser: e.target.value } : null)}
                className="block w-full px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-lg text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500/15 focus:border-blue-500 text-sm"
              />
            </div>
          </div>
        ...
        {user.role === "Super Admin" && (
          <div className="flex justify-end pt-2">
            <button
              type="submit"
              disabled={saving}
              className="flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white font-medium rounded-md shadow-sm transition-all text-sm disabled:opacity-50"
            >
